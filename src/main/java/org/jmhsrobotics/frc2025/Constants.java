...
public final class Constants {
  ...
  public static final class IndexerConstants {
    ...
    public static final double kRotationDownDegrees = 4.5;
    public static final double kRotationMidDegrees = 145;
  ...
  public static final class ClimberConstants {
    ...
    public static final double kSoftLimitTopDegrees = 16;
    public static final double kStowAngle = 45;
    public static final double kSoftLimitBottomDegrees = 105;
  }

...
public class ScoreBargeWrist extends Command{
    ...
    public void initialize() {
        if (elevator.getSetpoint() == Constants.ElevatorConstants.kBargeMeters && elevator.atGoal()) readyToScore = true;
    ...
    @Override
    public void execute() {
        if (elevator.getSetpoint() == Constants.ElevatorConstants.kBargeMeters && elevator.atGoal()) timer.start();

 ...
 */
public class ProfiledPIDControllerCustom implements Sendable {
  ...
  private TrapezoidProfileCustom.Constraints m_constraints;
  private TrapezoidProfileCustom m_profile;
  private TrapezoidProfileCustom.State m_goal = new TrapezoidProfileCustom.State();
  private TrapezoidProfileCustom.State m_setpoint = new TrapezoidProfileCustom.State();
   ...
   */
  public ProfiledPIDControllerCustom(
      double Kp, double Ki, double Kd, TrapezoidProfileCustom.Constraints constraints) {
  ...
  public ProfiledPIDControllerCustom(
      ...
      double Ki,
      double Kd,
      TrapezoidProfileCustom.Constraints constraints,
      double period) {
    m_controller = new PIDController(Kp, Ki, Kd, period);
    m_constraints = constraints;
    m_profile = new TrapezoidProfileCustom(m_constraints);
    instances++;
   ...
   */
  public void setGoal(TrapezoidProfileCustom.State goal) {
    m_goal = goal;
  }
  ...
  public void setGoal(double goal) {
    m_goal = new TrapezoidProfileCustom.State(goal, 0);
  }
   ...
   * @return The goal.
   */
  public TrapezoidProfileCustom.State getGoal() {
    return m_goal;
  }
   ...
   * @param constraints Velocity and acceleration constraints for goal.
   */
  public void setConstraints(TrapezoidProfileCustom.Constraints constraints) {
    m_constraints = constraints;
    m_profile = new TrapezoidProfileCustom(m_constraints);
  }
   ...
   */
  public TrapezoidProfileCustom.Constraints getConstraints() {
   ...
   */
  public TrapezoidProfileCustom.State getSetpoint() {
    return m_setpoint;
  }
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, TrapezoidProfileCustom.State goal) {
    setGoal(goal);
  ...
  public double calculate(
      double measurement,
      TrapezoidProfileCustom.State goal,
      TrapezoidProfileCustom.Constraints constraints) {
   ...
   */
  public void reset(TrapezoidProfileCustom.State measurement) {
    m_controller.reset();
  ...
  public void reset(double measuredPosition, double measuredVelocity) {
    reset(new TrapezoidProfileCustom.State(measuredPosition, measuredVelocity));
  }
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty(
        ...
        maxVelocity ->
            setConstraints(
                new TrapezoidProfileCustom.Constraints(
                    maxVelocity,
                    getConstraints().maxAcceleration,
                    getConstraints().maxDeceleration)));
    builder.addDoubleProperty(
        "maxAcceleration",
        () -> getConstraints().maxAcceleration,
        maxAcceleration ->

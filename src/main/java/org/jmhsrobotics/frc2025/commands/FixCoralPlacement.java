...
public class FixCoralPlacement extends Command {
  ...
  public boolean isFinished() {
    // stops if coral is back in front of the sensor or 3 seconds have passed meaning the coral was
    // extaked out the front uninentionally
